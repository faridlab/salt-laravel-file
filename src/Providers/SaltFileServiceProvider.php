...
namespace SaltFile\Providers;

use Illuminate\Support\ServiceProvider;

class SaltFileServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        $this->publishes([
            __DIR__.'/../../config/salt-laravel-file.php' => config_path('salt-laravel-file.php'),
        ], 'file-config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-file');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-file');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-laravel-file'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-laravel-file');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-laravel-file'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltFile\Console\Commands\SaltFileCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-laravel-file'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-laravel-file.php', 'salt-laravel-file'
        // );
    }
}
